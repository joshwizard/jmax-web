...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Jmax Builders Ltd — residential and commercial construction based in Nairobi, serving clients across Kenya. Buy ready-to-build plans and Bills of Quantities from our marketplace." },
