...
const faqs: { q: string; a: string; group: string }[] = [
  ...
  { group: "Construction services", q: "Do you build outside Nairobi?", a: "Yes. We build across Kenya. Mobilisation costs to sites outside Nairobi are reflected in the quote." },
    ...
    <Layout>
      ...
      <section className="container-page py-12">
        <div className="max-w-2xl">
          <p className="font-mono text-sm uppercase tracking-[0.3em] text-primary">Frequently asked</p>
          <h1 className="mt-2 font-display text-4xl font-bold tracking-tight md:text-5xl">Questions, clearly answered</h1>
          <p className="mt-3 text-lg text-muted-foreground">Licensing, formats, BOQ rates, refunds — straight answers, no fluff.</p>
        </div>
        ...
        <div className="mt-14 rounded-xl border border-border bg-secondary/40 p-6 text-center">
          ...
          <p className="mt-1 text-base text-muted-foreground">Email <a className="underline hover:text-primary" href="mailto:jmaxbuildersltd@gmail.com">jmaxbuildersltd@gmail.com</a> and we'll respond within one business day.</p>
        </div>
      </section>
    </Layout>
  );
