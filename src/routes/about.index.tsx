        ...
        <div className="container-page grid gap-10 py-16 md:grid-cols-[1.1fr_1fr] md:items-center">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link to="/about/services" className="inline-flex items-center gap-2 rounded-md bg-ink px-5 py-3 text-sm font-bold text-ink-foreground hover:opacity-90">
                Our services <ArrowRight className="h-4 w-4" />
              </Link>
              <Link to="/portfolio" className="inline-flex items-center gap-2 rounded-md border border-border bg-card px-5 py-3 text-sm font-semibold hover:bg-accent">
                See our work
              </Link>
            </div>
          </div>
